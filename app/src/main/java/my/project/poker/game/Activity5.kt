...
class Activity5 : AppCompatActivity() {
    ...
    private fun NumberPicker.setBribesListener() {
        this.doOnProgressChanged { _, _, _ ->
            val int =
                numberOfCardsInt[position] - bribes.progress - bribes2.progress - bribes3.progress - bribes4.progress - bribes5.progress
            val supp: String
            supp = if (int < 0)
    ...
    private fun numberOfCardsIntInit() {
        when (numberOfGames) {
            5 -> {
                numberOfCardsInt =
                    arrayOf(1, 2, 3, 4, 5, 5, 5, 5, 5, 4, 3, 2, 1)
                pointsPlayer1 = Array(13) { 0 }
                pointsPlayer2 = Array(13) { 0 }
                pointsPlayer3 = Array(13) { 0 }
                pointsPlayer4 = Array(13) { 0 }
                pointsPlayer5 = Array(13) { 0 }
            }
            6 -> {
                numberOfCardsInt =
                    arrayOf(1, 2, 3, 4, 5, 6, 6, 6, 6, 6, 5, 4, 3, 2, 1)
                pointsPlayer1 = Array(15) { 0 }
                pointsPlayer2 = Array(15) { 0 }
                pointsPlayer3 = Array(15) { 0 }
                pointsPlayer4 = Array(15) { 0 }
                pointsPlayer5 = Array(15) { 0 }
            }
        }
    }
    ...
    fun onScoreClick(view: View) {
        val intent = Intent(this@Activity5, ScoreActivity5::class.java)
    ...
    private fun showMenuDialog() {
        IonAlert(this, IonAlert.NORMAL_TYPE)
            ...
            .showCancelButton(true)
            .setConfirmClickListener { sDialog: IonAlert ->
                val intent = Intent(this@Activity5, MenuActivity::class.java)
                startActivity(intent)
                finish()
                overridePendingTransition(
